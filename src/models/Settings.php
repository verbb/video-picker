...
class Settings extends Model
{
    ...
    private static function _normalizeDomainList(mixed $value): array
    {
    ...
    /** Host allowlist for Twig embed helpers; empty means any public host. */
    ...
    public function setAttributes($values, $safeOnly = true): void
    {
        if (array_key_exists('embedAllowedDomains', $values)) {
            $values['embedAllowedDomains'] = self::_normalizeDomainList($values['embedAllowedDomains']);
        }
